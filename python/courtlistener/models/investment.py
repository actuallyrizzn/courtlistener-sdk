"""
Investment model for CourtListener SDK.
"""
...
class Investment(BaseModel):
    """Model representing an investment from financial disclosures."""
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.value_min: Optional[float] = data.get('value_min')
        self.value_max: Optional[float] = data.get('value_max')
