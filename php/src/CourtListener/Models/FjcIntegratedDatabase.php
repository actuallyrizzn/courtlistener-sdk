...
/**
 * FJC Integrated Database model
 * 
 * @package CourtListener\Models
 */
class FjcIntegratedDatabase extends BaseModel
{
    /**
     * Constructor
     *
    ...
    public function __toString()
    {
        ...
        if ($name && $id) {
            return "FjcIntegratedDatabase #{$id}: {$name}";
        } elseif ($id) {
            return "FjcIntegratedDatabase #{$id}";
        } else {
            return "FjcIntegratedDatabase";
        }
    }
}