...
/**
 * Originating Court Information model
 * 
 * @package CourtListener\Models
 */
class OriginatingCourtInformation extends BaseModel
{
    /**
     * Constructor
     *
    ...
    public function __toString()
    {
        ...
        if ($name && $id) {
            return "OriginatingCourtInformation #{$id}: {$name}";
        } elseif ($id) {
            return "OriginatingCourtInformation #{$id}";
        } else {
