...
/**
 * Non Investment Income model
 * 
 * @package CourtListener\Models
 */
class NonInvestmentIncome extends BaseModel
{
    /**
     * Constructor
     *
    ...
    public function __toString()
    {
        ...
        if ($name && $id) {
            return "NonInvestmentIncome #{$id}: {$name}";
        } elseif ($id) {
            return "NonInvestmentIncome #{$id}";
        } else {
            return "NonInvestmentIncome";
        }
    }
}