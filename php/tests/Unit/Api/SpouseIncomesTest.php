...
class SpouseIncomesTest extends TestCase
{
    private SpouseIncomes $endpoint;
    private MockObject $client;

    protected function setUp(): void
    {
        $this->client = $this->createMock(CourtListenerClient::class);
        $this->endpoint = new SpouseIncomes($this->client);
    }
    ...
    public function testList()
    {
        $expectedResponse = [
            'count' => 100,
            'next' => 'http://api.example.com/spouse-incomes/?page=2',
            'previous' => null,
            'results' => [
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/', ['query' => ['page' => 1]])
    ...
    public function testGet()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/123/', ['query' => []])
            ->willReturn($expectedResponse);
    ...
    public function testSearch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/search/', ['query' => ['q' => 'test']])
            ->willReturn($expectedResponse);
    ...
    public function testCreate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('POST', 'spouse-incomes/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testUpdate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PUT', 'spouse-incomes/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testPatch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PATCH', 'spouse-incomes/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testDelete()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('DELETE', 'spouse-incomes/123/')
            ->willReturn($expectedResponse);
    ...
    public function testListWithPagination()
    {
        $expectedResponse = [
            'count' => 200,
            'next' => 'http://api.example.com/spouse-incomes/?page=3',
            'previous' => 'http://api.example.com/spouse-incomes/?page=1',
            'results' => []
        ];
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testListWithFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/', ['query' => $filters])
            ->willReturn($expectedResponse);
    ...
    public function testSearchWithComplexFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/search/', ['query' => $searchParams])
            ->willReturn($expectedResponse);
    ...
    public function testGetWithParams()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'spouse-incomes/789/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testEndpointName()
    {
        ...
        $this->assertEquals('SpouseIncomes', $reflection->getShortName());
    }
