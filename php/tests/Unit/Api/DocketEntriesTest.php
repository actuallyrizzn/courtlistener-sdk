...
class DocketEntriesTest extends TestCase
{
    private DocketEntries $endpoint;
    private MockObject $client;

    protected function setUp(): void
    {
        $this->client = $this->createMock(CourtListenerClient::class);
        $this->endpoint = new DocketEntries($this->client);
    }
    ...
    public function testList()
    {
        $expectedResponse = [
            'count' => 100,
            'next' => 'http://api.example.com/docket-entries/?page=2',
            'previous' => null,
            'results' => [
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/', ['query' => ['page' => 1]])
    ...
    public function testGet()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/123/', ['query' => []])
            ->willReturn($expectedResponse);
    ...
    public function testSearch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/search/', ['query' => ['q' => 'test']])
            ->willReturn($expectedResponse);
    ...
    public function testCreate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('POST', 'docket-entries/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testUpdate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PUT', 'docket-entries/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testPatch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PATCH', 'docket-entries/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testDelete()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('DELETE', 'docket-entries/123/')
            ->willReturn($expectedResponse);
    ...
    public function testListWithPagination()
    {
        $expectedResponse = [
            'count' => 200,
            'next' => 'http://api.example.com/docket-entries/?page=3',
            'previous' => 'http://api.example.com/docket-entries/?page=1',
            'results' => []
        ];
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testListWithFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/', ['query' => $filters])
            ->willReturn($expectedResponse);
    ...
    public function testSearchWithComplexFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/search/', ['query' => $searchParams])
            ->willReturn($expectedResponse);
    ...
    public function testGetWithParams()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'docket-entries/789/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testEndpointName()
    {
        ...
        $this->assertEquals('DocketEntries', $reflection->getShortName());
    }
