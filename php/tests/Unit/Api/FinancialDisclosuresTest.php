...
class FinancialDisclosuresTest extends TestCase
{
    private FinancialDisclosures $endpoint;
    private MockObject $client;

    protected function setUp(): void
    {
        $this->client = $this->createMock(CourtListenerClient::class);
        $this->endpoint = new FinancialDisclosures($this->client);
    }
    ...
    public function testList()
    {
        $expectedResponse = [
            'count' => 100,
            'next' => 'http://api.example.com/financial-disclosures/?page=2',
            'previous' => null,
            'results' => [
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/', ['query' => ['page' => 1]])
    ...
    public function testGet()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/123/', ['query' => []])
            ->willReturn($expectedResponse);
    ...
    public function testSearch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/search/', ['query' => ['q' => 'test']])
            ->willReturn($expectedResponse);
    ...
    public function testCreate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('POST', 'financial-disclosures/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testUpdate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PUT', 'financial-disclosures/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testPatch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PATCH', 'financial-disclosures/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testDelete()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('DELETE', 'financial-disclosures/123/')
            ->willReturn($expectedResponse);
    ...
    public function testListWithPagination()
    {
        $expectedResponse = [
            'count' => 200,
            'next' => 'http://api.example.com/financial-disclosures/?page=3',
            'previous' => 'http://api.example.com/financial-disclosures/?page=1',
            'results' => []
        ];
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testListWithFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/', ['query' => $filters])
            ->willReturn($expectedResponse);
    ...
    public function testSearchWithComplexFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/search/', ['query' => $searchParams])
            ->willReturn($expectedResponse);
    ...
    public function testGetWithParams()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'financial-disclosures/789/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testEndpointName()
    {
        ...
        $this->assertEquals('FinancialDisclosures', $reflection->getShortName());
    }
