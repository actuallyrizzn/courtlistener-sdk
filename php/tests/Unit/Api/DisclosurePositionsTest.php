...
class DisclosurePositionsTest extends TestCase
{
    private DisclosurePositions $endpoint;
    private MockObject $client;

    protected function setUp(): void
    {
        $this->client = $this->createMock(CourtListenerClient::class);
        $this->endpoint = new DisclosurePositions($this->client);
    }
    ...
    public function testList()
    {
        $expectedResponse = [
            'count' => 100,
            'next' => 'http://api.example.com/disclosure-positions/?page=2',
            'previous' => null,
            'results' => [
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/', ['query' => ['page' => 1]])
    ...
    public function testGet()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/123/', ['query' => []])
            ->willReturn($expectedResponse);
    ...
    public function testSearch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/search/', ['query' => ['q' => 'test']])
            ->willReturn($expectedResponse);
    ...
    public function testCreate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('POST', 'disclosure-positions/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testUpdate()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PUT', 'disclosure-positions/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testPatch()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('PATCH', 'disclosure-positions/123/', ['json' => $data])
            ->willReturn($expectedResponse);
    ...
    public function testDelete()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('DELETE', 'disclosure-positions/123/')
            ->willReturn($expectedResponse);
    ...
    public function testListWithPagination()
    {
        $expectedResponse = [
            'count' => 200,
            'next' => 'http://api.example.com/disclosure-positions/?page=3',
            'previous' => 'http://api.example.com/disclosure-positions/?page=1',
            'results' => []
        ];
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testListWithFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/', ['query' => $filters])
            ->willReturn($expectedResponse);
    ...
    public function testSearchWithComplexFilters()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/search/', ['query' => $searchParams])
            ->willReturn($expectedResponse);
    ...
    public function testGetWithParams()
    {
        ...
        $this->client->expects($this->once())
            ->method('makeRequest')
            ->with('GET', 'disclosure-positions/789/', ['query' => $params])
            ->willReturn($expectedResponse);
    ...
    public function testEndpointName()
    {
        ...
        $this->assertEquals('DisclosurePositions', $reflection->getShortName());
    }
