...
use CourtListener\Models\Party;
...
class PartyTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Party::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Party($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Party', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Party($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Party', $model->getName());
