...
use CourtListener\Models\Alert;
...
class AlertTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Alert::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Alert($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Alert', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Alert($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Alert', $model->getName());
