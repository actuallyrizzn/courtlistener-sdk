...
use CourtListener\Models\DisclosurePosition;
use PHPUnit\Framework\TestCase;

class DisclosurePositionTest extends TestCase
{
    private DisclosurePosition $model;

    protected function setUp(): void
    {
        $this->model = new DisclosurePosition();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(DisclosurePosition::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Disclosure Position',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new DisclosurePosition($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Disclosure Position', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'DisclosurePosition #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'DisclosurePosition #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Disclosure Position',
            'title' => 'Test Title',
        ...
        $model = new DisclosurePosition($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Disclosure Position', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new DisclosurePosition($partialData);
