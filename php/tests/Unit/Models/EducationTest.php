...
use CourtListener\Models\Education;
...
class EducationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Education::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Education($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Education', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Education #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Education',
            'title' => 'Test Title',
        ...
        $model = new Education($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Education', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Education($partialData);
