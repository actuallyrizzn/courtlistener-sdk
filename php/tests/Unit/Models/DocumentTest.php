...
use CourtListener\Models\Document;
...
class DocumentTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Document::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Document($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Document', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Document #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Document($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Document', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Document($partialData);
