...
use CourtListener\Models\Financial;
...
class FinancialTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Financial::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Financial($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Financial', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Financial #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Financial',
            'title' => 'Test Title',
        ...
        $model = new Financial($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Financial', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Financial($partialData);
