...
class GiftTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Gift::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Gift', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Gift($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Gift', $model->getName());
