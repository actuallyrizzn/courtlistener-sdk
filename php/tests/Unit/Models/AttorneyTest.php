...
use CourtListener\Models\Attorney;
...
class AttorneyTest extends TestCase
{
    ...
    {
        $this->model = new Attorney();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(Attorney::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Attorney', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Attorney #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Attorney',
            'title' => 'Test Title',
        ...
        $model = new Attorney($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Attorney', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Attorney($partialData);
