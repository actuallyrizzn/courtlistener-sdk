...
use CourtListener\Models\DocketAlert;
use PHPUnit\Framework\TestCase;

class DocketAlertTest extends TestCase
{
    private DocketAlert $model;

    protected function setUp(): void
    {
        $this->model = new DocketAlert();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(DocketAlert::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Docket Alert',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new DocketAlert($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Docket Alert', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'DocketAlert #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Docket Alert',
            'title' => 'Test Title',
        ...
        $model = new DocketAlert($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Docket Alert', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new DocketAlert($partialData);
