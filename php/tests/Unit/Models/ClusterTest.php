...
use CourtListener\Models\Cluster;
...
class ClusterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Cluster::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Cluster($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Cluster', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Cluster #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Cluster($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Cluster', $model->getName());
