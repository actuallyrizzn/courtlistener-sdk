...
use CourtListener\Models\PoliticalAffiliation;
use PHPUnit\Framework\TestCase;

class PoliticalAffiliationTest extends TestCase
{
    private PoliticalAffiliation $model;

    protected function setUp(): void
    {
        $this->model = new PoliticalAffiliation();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(PoliticalAffiliation::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Political Affiliation',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new PoliticalAffiliation($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Political Affiliation', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'PoliticalAffiliation #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'PoliticalAffiliation #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Political Affiliation',
            'title' => 'Test Title',
        ...
        $model = new PoliticalAffiliation($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Political Affiliation', $model->getName());
    ...
    {
        $model = new PoliticalAffiliation([]);
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new PoliticalAffiliation($partialData);
