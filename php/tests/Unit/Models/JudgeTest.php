...
use CourtListener\Models\Judge;
...
class JudgeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Judge::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Judge($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Judge', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Judge($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Judge', $model->getName());
