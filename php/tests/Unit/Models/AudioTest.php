...
use CourtListener\Models\Audio;
...
class AudioTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Audio::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Audio($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Audio', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Audio($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Audio', $model->getName());
