...
use CourtListener\Models\Citation;
...
class CitationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Citation::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Citation', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Citation #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Citation',
            'title' => 'Test Title',
        ...
        $model = new Citation($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Citation', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Citation($partialData);
