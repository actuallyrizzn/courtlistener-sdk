...
class TagTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Tag::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Tag', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Tag($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Tag', $model->getName());
