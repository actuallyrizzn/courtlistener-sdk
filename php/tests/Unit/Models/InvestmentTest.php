...
use CourtListener\Models\Investment;
...
class InvestmentTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Investment::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Investment($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Investment', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Investment #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Investment',
            'title' => 'Test Title',
        ...
        $model = new Investment($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Investment', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Investment($partialData);
