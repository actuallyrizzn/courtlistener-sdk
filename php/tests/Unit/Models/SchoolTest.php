...
use CourtListener\Models\School;
...
class SchoolTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(School::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new School($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test School', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new School($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test School', $model->getName());
