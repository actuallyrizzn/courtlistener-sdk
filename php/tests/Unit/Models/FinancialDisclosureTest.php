...
class FinancialDisclosureTest extends TestCase
{
    private FinancialDisclosure $model;

    protected function setUp(): void
    {
        $this->model = new FinancialDisclosure();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(FinancialDisclosure::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Financial Disclosure',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new FinancialDisclosure($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Financial Disclosure', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'FinancialDisclosure #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'FinancialDisclosure #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Financial Disclosure',
            'title' => 'Test Title',
        ...
        $model = new FinancialDisclosure($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Financial Disclosure', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new FinancialDisclosure($partialData);
