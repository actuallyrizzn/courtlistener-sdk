...
use CourtListener\Models\RecapDocument;
use PHPUnit\Framework\TestCase;

class RecapDocumentTest extends TestCase
{
    private RecapDocument $model;

    protected function setUp(): void
    {
        $this->model = new RecapDocument();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(RecapDocument::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test RECAP Document',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new RecapDocument($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test RECAP Document', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'RecapDocument #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test RECAP Document',
            'title' => 'Test Title',
        ...
        $model = new RecapDocument($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test RECAP Document', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new RecapDocument($partialData);
