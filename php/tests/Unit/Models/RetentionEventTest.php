...
use CourtListener\Models\RetentionEvent;
use PHPUnit\Framework\TestCase;

class RetentionEventTest extends TestCase
{
    private RetentionEvent $model;

    protected function setUp(): void
    {
        $this->model = new RetentionEvent();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(RetentionEvent::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Retention Event',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new RetentionEvent($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Retention Event', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'RetentionEvent #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Retention Event',
            'title' => 'Test Title',
        ...
        $model = new RetentionEvent($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Retention Event', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new RetentionEvent($partialData);
