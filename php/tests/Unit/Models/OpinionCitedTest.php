...
use CourtListener\Models\OpinionCited;
use PHPUnit\Framework\TestCase;

class OpinionCitedTest extends TestCase
{
    private OpinionCited $model;

    protected function setUp(): void
    {
        $this->model = new OpinionCited();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(OpinionCited::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Opinion Cited',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new OpinionCited($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Opinion Cited', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'OpinionCited #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Opinion Cited',
            'title' => 'Test Title',
        ...
        $model = new OpinionCited($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Opinion Cited', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new OpinionCited($partialData);
