...
use CourtListener\Models\SpouseIncome;
use PHPUnit\Framework\TestCase;

class SpouseIncomeTest extends TestCase
{
    private SpouseIncome $model;

    protected function setUp(): void
    {
        $this->model = new SpouseIncome();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(SpouseIncome::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Spouse Income',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new SpouseIncome($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Spouse Income', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'SpouseIncome #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Spouse Income',
            'title' => 'Test Title',
        ...
        $model = new SpouseIncome($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Spouse Income', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new SpouseIncome($partialData);
