...
use CourtListener\Models\Agreement;
...
class AgreementTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Agreement::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Agreement($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Agreement', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Agreement #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Agreement',
            'title' => 'Test Title',
        ...
        $model = new Agreement($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Agreement', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Agreement($partialData);
