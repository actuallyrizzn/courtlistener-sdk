...
use CourtListener\Models\Source;
...
class SourceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Source::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Source($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Source', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Source($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Source', $model->getName());
