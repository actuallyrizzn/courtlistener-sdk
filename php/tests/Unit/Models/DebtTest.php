...
class DebtTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Debt::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Debt', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Debt($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Debt', $model->getName());
