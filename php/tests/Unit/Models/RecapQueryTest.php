...
use CourtListener\Models\RecapQuery;
use PHPUnit\Framework\TestCase;

class RecapQueryTest extends TestCase
{
    private RecapQuery $model;

    protected function setUp(): void
    {
        $this->model = new RecapQuery();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(RecapQuery::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test RECAP Query',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new RecapQuery($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test RECAP Query', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'RecapQuery #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test RECAP Query',
            'title' => 'Test Title',
        ...
        $model = new RecapQuery($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test RECAP Query', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new RecapQuery($partialData);
