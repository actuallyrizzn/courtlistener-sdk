...
use CourtListener\Models\FjcIntegratedDatabase;
use PHPUnit\Framework\TestCase;

class FjcIntegratedDatabaseTest extends TestCase
{
    private FjcIntegratedDatabase $model;

    protected function setUp(): void
    {
        $this->model = new FjcIntegratedDatabase();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(FjcIntegratedDatabase::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test FJC Integrated Database',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new FjcIntegratedDatabase($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test FJC Integrated Database', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'FjcIntegratedDatabase #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'FjcIntegratedDatabase #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testToStringWithNameOnly()
    {
        ...
        $expected = 'FjcIntegratedDatabase';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test FJC Integrated Database',
            'title' => 'Test Title',
        ...
        $model = new FjcIntegratedDatabase($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test FJC Integrated Database', $model->getName());
    ...
    {
        $model = new FjcIntegratedDatabase([]);
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new FjcIntegratedDatabase($partialData);
