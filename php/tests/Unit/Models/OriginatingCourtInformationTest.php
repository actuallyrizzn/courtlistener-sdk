...
use CourtListener\Models\OriginatingCourtInformation;
use PHPUnit\Framework\TestCase;

class OriginatingCourtInformationTest extends TestCase
{
    private OriginatingCourtInformation $model;

    protected function setUp(): void
    {
        $this->model = new OriginatingCourtInformation();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(OriginatingCourtInformation::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Originating Court Information',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new OriginatingCourtInformation($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Originating Court Information', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'OriginatingCourtInformation #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'OriginatingCourtInformation #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testToStringWithNameOnly()
    {
        ...
        $expected = 'OriginatingCourtInformation';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Originating Court Information',
            'title' => 'Test Title',
        ...
        $model = new OriginatingCourtInformation($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Originating Court Information', $model->getName());
    ...
    {
        $model = new OriginatingCourtInformation([]);
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new OriginatingCourtInformation($partialData);
