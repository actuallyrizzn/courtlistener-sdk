...
use CourtListener\Models\Person;
...
class PersonTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Person::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $this->assertEquals('Test Person', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Person($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Person', $model->getName());
