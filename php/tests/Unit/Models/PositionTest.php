...
use CourtListener\Models\Position;
...
class PositionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Position::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Position($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Position', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Position #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Position',
            'title' => 'Test Title',
        ...
        $model = new Position($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Position', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Position($partialData);
