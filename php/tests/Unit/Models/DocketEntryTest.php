...
use CourtListener\Models\DocketEntry;
use PHPUnit\Framework\TestCase;

class DocketEntryTest extends TestCase
{
    private DocketEntry $model;

    protected function setUp(): void
    {
        $this->model = new DocketEntry();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(DocketEntry::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Docket Entry',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new DocketEntry($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Docket Entry', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'DocketEntry #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Docket Entry',
            'title' => 'Test Title',
        ...
        $model = new DocketEntry($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Docket Entry', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new DocketEntry($partialData);
