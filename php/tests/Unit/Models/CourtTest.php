...
use CourtListener\Models\Court;
...
class CourtTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Court::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Court($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Court', $model->getName());
    }
    ...
    public function testModelWithComprehensiveData()
    {
        ...
        $model = new Court($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Court', $model->getName());
