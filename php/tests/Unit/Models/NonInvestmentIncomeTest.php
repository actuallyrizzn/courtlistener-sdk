...
use CourtListener\Models\NonInvestmentIncome;
use PHPUnit\Framework\TestCase;

class NonInvestmentIncomeTest extends TestCase
{
    private NonInvestmentIncome $model;

    protected function setUp(): void
    {
        $this->model = new NonInvestmentIncome();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(NonInvestmentIncome::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        $data = [
            'id' => 123,
            'name' => 'Test Non Investment Income',
            'date_created' => '2023-01-01T00:00:00Z',
            'date_modified' => '2023-01-02T00:00:00Z'
        ];
        
        $model = new NonInvestmentIncome($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Non Investment Income', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'NonInvestmentIncome #789: Test Name';
    ...
    public function testToStringWithIdOnly()
    {
        ...
        $expected = 'NonInvestmentIncome #789';
        $this->assertEquals($expected, (string) $this->model);
    }
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Non Investment Income',
            'title' => 'Test Title',
        ...
        $model = new NonInvestmentIncome($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Non Investment Income', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new NonInvestmentIncome($partialData);
