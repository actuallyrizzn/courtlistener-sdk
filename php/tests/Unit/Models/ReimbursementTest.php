...
use CourtListener\Models\Reimbursement;
use PHPUnit\Framework\TestCase;

class ReimbursementTest extends TestCase
{
    private Reimbursement $model;

    protected function setUp(): void
    {
        $this->model = new Reimbursement();
    }

    public function testConstructor()
    {
        $this->assertInstanceOf(Reimbursement::class, $this->model);
    }
    ...
    public function testConstructorWithData()
    {
        ...
        $model = new Reimbursement($data);
        $this->assertEquals(123, $model->getId());
        $this->assertEquals('Test Reimbursement', $model->getName());
    }
    ...
    public function testToStringWithIdAndName()
    {
        ...
        $expected = 'Reimbursement #789: Test Name';
    ...
    public function testModelWithComprehensiveData()
    {
        $comprehensiveData = [
            'id' => 999,
            'name' => 'Comprehensive Test Reimbursement',
            'title' => 'Test Title',
        ...
        $model = new Reimbursement($comprehensiveData);
        
        $this->assertEquals(999, $model->getId());
        $this->assertEquals('Comprehensive Test Reimbursement', $model->getName());
    ...
    public function testModelWithPartialData()
    {
        ...
        $model = new Reimbursement($partialData);
