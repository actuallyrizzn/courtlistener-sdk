...
class PositionsLiveTest extends TestCase
{
    ...
    public function testListPositions()
    {
        ...
        // Validate response$results = $this->client->positions->list(Pagination::getParams(1, 5));
    ...
    public function testGetPositionsById()
    {
        ...
        // Validate response$results = $this->client->positions->list(Pagination::getParams(1, 1));
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
    ...
    public function testPositionsWithFilters()
    {
        ...
        // Validate response$results = $this->client->positions->list($filters);
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
    ...
    public function testPositionsSearchWithComplexFilters()
    {
        ...
        // Validate response$results = $this->client->positions->search($searchParams);
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
