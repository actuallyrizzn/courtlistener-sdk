...
class ClustersLiveTest extends TestCase
{
    ...
    public function testListClusters()
    {
        ...
        $results = $this->client->clusters->list(Pagination::getParams(1, 5));
    ...
    public function testGetClustersById()
    {
        ...
        $results = $this->client->clusters->list(Pagination::getParams(1, 1));
    ...
    public function testClustersWithFilters()
    {
        ...
        $results = $this->client->clusters->list($filters);
    ...
    public function testClustersSearchWithComplexFilters()
    {
        ...
        $results = $this->client->clusters->search($searchParams);
