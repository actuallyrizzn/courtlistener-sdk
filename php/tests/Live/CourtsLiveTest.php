...
class CourtsLiveTest extends TestCase
{
    ...
    public function testListCourts()
    {
        ...
        $results = $this->client->Courts->list(Pagination::getParams(1, 5));
    ...
    public function testGetCourtsById()
    {
        ...
        $results = $this->client->Courts->list(Pagination::getParams(1, 1));
    ...
    public function testCourtsWithFilters()
    {
        ...
        $results = $this->client->Courts->list($filters);
    ...
    public function testCourtsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->Courts->search($searchParams);
