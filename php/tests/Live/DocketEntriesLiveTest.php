...
class DocketEntriesLiveTest extends TestCase
{
    ...
    public function testListDocketEntries()
    {
        ...
        $results = $this->client->DocketEntries->list(Pagination::getParams(1, 5));
    ...
    public function testGetDocketEntriesById()
    {
        ...
        $results = $this->client->DocketEntries->list(Pagination::getParams(1, 1));
    ...
    public function testDocketEntriesWithFilters()
    {
        ...
        $results = $this->client->DocketEntries->list($filters);
    ...
    public function testDocketEntriesSearchWithComplexFilters()
    {
        ...
        $results = $this->client->DocketEntries->search($searchParams);
