...
class OpinionsCitedLiveTest extends TestCase
{
    ...
    public function testListOpinionsCited()
    {
        ...
        $results = $this->client->OpinionsCited->list(Pagination::getParams(1, 5));
    ...
    public function testGetOpinionsCitedById()
    {
        ...
        $results = $this->client->OpinionsCited->list(Pagination::getParams(1, 1));
    ...
    public function testOpinionsCitedWithFilters()
    {
        ...
        $results = $this->client->OpinionsCited->list($filters);
    ...
    public function testOpinionsCitedSearchWithComplexFilters()
    {
        ...
        $results = $this->client->OpinionsCited->search($searchParams);
