...
class EducationsLiveTest extends TestCase
{
    ...
    public function testListEducations()
    {
        ...
        $results = $this->client->Educations->list(Pagination::getParams(1, 5));
    ...
    public function testGetEducationsById()
    {
        ...
        $results = $this->client->Educations->list(Pagination::getParams(1, 1));
    ...
    public function testEducationsWithFilters()
    {
        ...
        $results = $this->client->Educations->list($filters);
    ...
    public function testEducationsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->Educations->search($searchParams);
