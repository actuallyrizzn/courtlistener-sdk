...
class RecapDocumentsLiveTest extends TestCase
{
    ...
    public function testListRecapDocuments()
    {
        ...
        $results = $this->client->recapDocuments->list(Pagination::getParams(1, 5));
    ...
    public function testGetRecapDocumentsById()
    {
        ...
        $results = $this->client->recapDocuments->list(Pagination::getParams(1, 1));
    ...
    public function testRecapDocumentsWithFilters()
    {
        ...
        $results = $this->client->recapDocuments->list($filters);
    ...
    public function testRecapDocumentsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->recapDocuments->search($searchParams);
