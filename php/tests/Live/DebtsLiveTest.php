...
class DebtsLiveTest extends TestCase
{
    ...
    public function testListDebts()
    {
        ...
        $results = $this->client->debts->list(Pagination::getParams(1, 5));
    ...
    public function testGetDebtsById()
    {
        ...
        $results = $this->client->debts->list(Pagination::getParams(1, 1));
    ...
    public function testDebtsWithFilters()
    {
        ...
        $results = $this->client->debts->list($filters);
    ...
    public function testDebtsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->debts->search($searchParams);
