...
class OpinionsLiveTest extends TestCase
{
    ...
    public function testListOpinions()
    {
        ...
        $results = $this->client->Opinions->list(Pagination::getParams(1, 5));
    ...
    public function testGetOpinionsById()
    {
        ...
        $results = $this->client->Opinions->list(Pagination::getParams(1, 1));
    ...
    public function testOpinionsWithFilters()
    {
        ...
        $results = $this->client->Opinions->list($filters);
    ...
    public function testOpinionsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->Opinions->search($searchParams);
