...
class InvestmentsLiveTest extends TestCase
{
    ...
    public function testListInvestments()
    {
        ...
        $results = $this->client->investments->list(Pagination::getParams(1, 5));
    ...
    public function testGetInvestmentsById()
    {
        ...
        $results = $this->client->investments->list(Pagination::getParams(1, 1));
    ...
    public function testInvestmentsWithFilters()
    {
        ...
        $results = $this->client->investments->list($filters);
    ...
    public function testInvestmentsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->investments->search($searchParams);
