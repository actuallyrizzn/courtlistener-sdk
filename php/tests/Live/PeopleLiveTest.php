...
class PeopleLiveTest extends TestCase
{
    ...
    public function testListPeople()
    {
        ...
        $results = $this->client->people->list(Pagination::getParams(1, 5));
    ...
    public function testGetPeopleById()
    {
        ...
        $results = $this->client->people->list(Pagination::getParams(1, 1));
    ...
    public function testPeopleWithFilters()
    {
        ...
        $results = $this->client->people->list($filters);
    ...
    public function testPeopleSearchWithComplexFilters()
    {
        ...
        $results = $this->client->people->search($searchParams);
