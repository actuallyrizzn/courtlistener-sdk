...
class SchoolsLiveTest extends TestCase
{
    ...
    public function testListSchools()
    {
        ...
        // Validate response$results = $this->client->schools->list(Pagination::getParams(1, 5));
    ...
    public function testGetSchoolsById()
    {
        ...
        // Validate response$results = $this->client->schools->list(Pagination::getParams(1, 1));
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
    ...
    public function testSchoolsWithFilters()
    {
        ...
        // Validate response$results = $this->client->schools->list($filters);
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
    ...
    public function testSchoolsSearchWithComplexFilters()
    {
        ...
        // Validate response$results = $this->client->schools->search($searchParams);
        if (empty($results) || !is_array($results)) { $this->markTestSkipped('API returned empty response or invalid data'); }
