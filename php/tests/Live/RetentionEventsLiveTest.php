...
class RetentionEventsLiveTest extends TestCase
{
    ...
    public function testListRetentionEvents()
    {
        ...
        $results = $this->client->retentionEvents->list(Pagination::getParams(1, 5));
    ...
    public function testGetRetentionEventsById()
    {
        ...
        $results = $this->client->retentionEvents->list(Pagination::getParams(1, 1));
    ...
    public function testRetentionEventsWithFilters()
    {
        ...
        $results = $this->client->retentionEvents->list($filters);
    ...
    public function testRetentionEventsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->retentionEvents->search($searchParams);
