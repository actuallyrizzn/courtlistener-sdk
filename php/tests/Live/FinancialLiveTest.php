...
class FinancialLiveTest extends TestCase
{
    ...
    public function testListFinancial()
    {
        ...
        $results = $this->client->financial->list(Pagination::getParams(1, 5));
    ...
    public function testGetFinancialById()
    {
        ...
        $results = $this->client->financial->list(Pagination::getParams(1, 1));
    ...
    public function testFinancialWithFilters()
    {
        ...
        $results = $this->client->financial->list($filters);
    ...
    public function testFinancialSearchWithComplexFilters()
    {
        ...
        $results = $this->client->financial->search($searchParams);
