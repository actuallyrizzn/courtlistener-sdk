...
class AbaRatingsLiveTest extends TestCase
{
    ...
    public function testListAbaRatings()
    {
        ...
        $results = $this->client->AbaRatings->list(Pagination::getParams(1, 5));
    ...
    public function testGetAbaRatingsById()
    {
        ...
        $results = $this->client->AbaRatings->list(Pagination::getParams(1, 1));
    ...
    public function testAbaRatingsWithFilters()
    {
        ...
        $results = $this->client->AbaRatings->list($filters);
    ...
    public function testAbaRatingsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->AbaRatings->search($searchParams);
