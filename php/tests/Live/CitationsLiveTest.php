...
class CitationsLiveTest extends TestCase
{
    ...
    public function testListCitations()
    {
        ...
        $results = $this->client->citations->list(Pagination::getParams(1, 5));
    ...
    public function testGetCitationsById()
    {
        ...
        $results = $this->client->citations->list(Pagination::getParams(1, 1));
    ...
    public function testCitationsWithFilters()
    {
        ...
        $results = $this->client->citations->list($filters);
    ...
    public function testCitationsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->citations->search($searchParams);
