...
class GiftsLiveTest extends TestCase
{
    ...
    public function testListGifts()
    {
        ...
        $results = $this->client->gifts->list(Pagination::getParams(1, 5));
    ...
    public function testGetGiftsById()
    {
        ...
        $results = $this->client->gifts->list(Pagination::getParams(1, 1));
    ...
    public function testGiftsWithFilters()
    {
        ...
        $results = $this->client->gifts->list($filters);
    ...
    public function testGiftsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->gifts->search($searchParams);
