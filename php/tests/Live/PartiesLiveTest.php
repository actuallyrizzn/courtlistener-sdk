...
class PartiesLiveTest extends TestCase
{
    ...
    public function testListParties()
    {
        ...
        $results = $this->client->Parties->list(Pagination::getParams(1, 5));
    ...
    public function testGetPartiesById()
    {
        ...
        $results = $this->client->Parties->list(Pagination::getParams(1, 1));
    ...
    public function testPartiesWithFilters()
    {
        ...
        $results = $this->client->Parties->list($filters);
    ...
    public function testPartiesSearchWithComplexFilters()
    {
        ...
        $results = $this->client->Parties->search($searchParams);
