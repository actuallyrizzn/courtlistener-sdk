...
class AlertsLiveTest extends TestCase
{
    ...
    public function testListAlerts()
    {
        ...
        $results = $this->client->alerts->list(Pagination::getParams(1, 5));
    ...
    public function testGetAlertsById()
    {
        ...
        $results = $this->client->alerts->list(Pagination::getParams(1, 1));
    ...
    public function testAlertsWithFilters()
    {
        ...
        $results = $this->client->alerts->list($filters);
    ...
    public function testAlertsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->alerts->search($searchParams);
