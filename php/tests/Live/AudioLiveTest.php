...
class AudioLiveTest extends TestCase
{
    ...
    public function testListAudio()
    {
        ...
        $results = $this->client->Audio->list(Pagination::getParams(1, 5));
    ...
    public function testGetAudioById()
    {
        ...
        $results = $this->client->Audio->list(Pagination::getParams(1, 1));
    ...
    public function testAudioWithFilters()
    {
        ...
        $results = $this->client->Audio->list($filters);
    ...
    public function testAudioSearchWithComplexFilters()
    {
        ...
        $results = $this->client->Audio->search($searchParams);
