...
class JudgesLiveTest extends TestCase
{
    ...
    public function testListJudges()
    {
        ...
        $results = $this->client->judges->list(Pagination::getParams(1, 5));
    ...
    public function testGetJudgesById()
    {
        ...
        $results = $this->client->judges->list(Pagination::getParams(1, 1));
    ...
    public function testJudgesWithFilters()
    {
        ...
        $results = $this->client->judges->list($filters);
    ...
    public function testJudgesSearchWithComplexFilters()
    {
        ...
        $results = $this->client->judges->search($searchParams);
