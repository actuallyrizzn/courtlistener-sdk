...
class DocketAlertsLiveTest extends TestCase
{
    ...
    public function testListDocketAlerts()
    {
        ...
        $results = $this->client->DocketAlerts->list(Pagination::getParams(1, 5));
    ...
    public function testGetDocketAlertsById()
    {
        ...
        $results = $this->client->DocketAlerts->list(Pagination::getParams(1, 1));
    ...
    public function testDocketAlertsWithFilters()
    {
        ...
        $results = $this->client->DocketAlerts->list($filters);
    ...
    public function testDocketAlertsSearchWithComplexFilters()
    {
        ...
        $results = $this->client->DocketAlerts->search($searchParams);
