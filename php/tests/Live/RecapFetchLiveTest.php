...
class RecapFetchLiveTest extends TestCase
{
    ...
    public function testListRecapFetch()
    {
        ...
        $results = $this->client->recapFetch->list(Pagination::getParams(1, 5));
    ...
    public function testGetRecapFetchById()
    {
        ...
        $results = $this->client->recapFetch->list(Pagination::getParams(1, 1));
    ...
    public function testRecapFetchWithFilters()
    {
        ...
        $results = $this->client->recapFetch->list($filters);
    ...
    public function testRecapFetchSearchWithComplexFilters()
    {
        ...
        $results = $this->client->recapFetch->search($searchParams);
