...
class AttorneysLiveTest extends TestCase
{
    ...
    public function testListAttorneys()
    {
        ...
        $results = $this->client->attorneys->list(Pagination::getParams(1, 5));
    ...
    public function testGetAttorneysById()
    {
        ...
        $results = $this->client->attorneys->list(Pagination::getParams(1, 1));
    ...
    public function testAttorneysWithFilters()
    {
        ...
        $results = $this->client->attorneys->list($filters);
    ...
    public function testAttorneysSearchWithComplexFilters()
    {
        ...
        $results = $this->client->attorneys->search($searchParams);
