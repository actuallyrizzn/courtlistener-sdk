...
class RecapQueryLiveTest extends TestCase
{
    ...
    public function testListRecapQuery()
    {
        ...
        $results = $this->client->RecapQuery->list(Pagination::getParams(1, 5));
    ...
    public function testGetRecapQueryById()
    {
        ...
        $results = $this->client->RecapQuery->list(Pagination::getParams(1, 1));
    ...
    public function testRecapQueryWithFilters()
    {
        ...
        $results = $this->client->RecapQuery->list($filters);
    ...
    public function testRecapQuerySearchWithComplexFilters()
    {
        ...
        $results = $this->client->RecapQuery->search($searchParams);
